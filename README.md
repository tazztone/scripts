...
A unified collection of utilities and automation scripts for Windows, Linux, and Python.
...
- For Bash scripts, see [sh/README.md](sh/README.md).
- For Python scripts, see [python/README.md](python/README.md).
- For Windows Batch scripts, see [bat/README.md](bat/README.md).

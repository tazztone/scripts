...
run_negative_test "imagemagick/Image-Magick-Toolbox.sh" "$TEST_DATA/src.jpg"
...
run_resilience_test "imagemagick/Image-Magick-Toolbox.sh" "format=jpeg" "$TEST_DATA/src.jpg"
unset ZENITY_QUESTION_RESPONSE

# 6. Error Case: No files selected
echo "Test 6: Error Case - No Files"
( bash "imagemagick/Image-Magick-Toolbox.sh" 2>/dev/null )
if [ $? -eq 1 ]; then

    ...
    for profile in zenity4; do
        ...
        case "$(basename "$script")" in
            *"Universal"*)
                ...
                # Correct 14-field mapping for Universal Toolbox
                # 0:Speed 1:CustomSpd 2:Res 3:CustomW 4:Crop 5:Rot 6:TrimS 7:TrimE 8:Audio 9:Subs 10:Qual 11:Target 12:Format 13:HW
